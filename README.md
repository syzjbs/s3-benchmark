> This project is a fork of upstream https://github.com/wasabi-tech/s3-benchmark with couple of changes
> - Removes ListObjectVersions usage
> - Avoids calculating Content-Md5 to speed up numbers on NVMe/flash based storage
...
# Note
Your performance testing benchmark results may vary most often because of limitations of your network connection to the cloud storage provider.  Wasabi performance claims are tested under conditions that remove any latency (which can be shown using the ping command) and bandwidth bottlenecks that restrict how fast data can be moved.  For more information, contact us at https://slack.min.io
